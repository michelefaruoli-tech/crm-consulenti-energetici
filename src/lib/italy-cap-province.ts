...
const CAP_RANGES: CapRange[] = [
  ...
  { from: 5000, to: 5999, sigla: "TR" },
  { from: 6000, to: 6999, sigla: "PG" },
  ...
  { from: 0, to: 999, sigla: "RM" },
  { from: 1000, to: 1999, sigla: "VT" },
  { from: 2000, to: 2999, sigla: "RI" },
  { from: 3000, to: 3999, sigla: "FR" },
  { from: 4000, to: 4999, sigla: "LT" },
  // Abruzzo / Molise
  ...
  { from: 7000, to: 7999, sigla: "SS" },
  { from: 8000, to: 8999, sigla: "NU" },
  { from: 9000, to: 9100, sigla: "CA" },
  { from: 9010, to: 9099, sigla: "SU" },
  { from: 7020, to: 7029, sigla: "OT" },
  { from: 8020, to: 8029, sigla: "OG" },
  { from: 8030, to: 8049, sigla: "NU" },
];
